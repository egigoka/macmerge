...
- [-] Ignore comment differences persists and handles C-family plus JavaScript/JSON/InstallShield, legacy hash-line, Python, SQL, markup, MATLAB, Properties, TOML, YAML, Basic, CSS, INI, TeX, Ada/VHDL, DCL, REXX, AutoLISP/SIOD, Fortran, NSIS, Resources, Verilog, Batch, Inno Setup, Lua, Pascal, D, Go, and Rust parser families, including WinMerge's whole-comment-line, UTF-16 tokenization, embedded-NUL, quote, column, continuation, language-mode, nested-depth, raw-string, long-delimiter, and aliased-cookie quirks; C/C++ digit-separator/raw-string and C# verbatim-string corners, HTML embedded languages, Tree-sitter-backed TypeScript/TSX, and remaining ABAP/ASP/AutoIt/F#/PHP/Smarty parser families are pending.
