...
- [-] Ignore comment differences persists and handles C-family plus JavaScript/JSON/InstallShield, legacy hash-line, Python, SQL, markup, MATLAB, Properties, TOML, YAML, Basic, CSS, INI, TeX, Ada/VHDL, DCL, REXX, AutoLISP/SIOD, Fortran, NSIS, Resources, Verilog, Batch, Inno Setup, Lua, and Pascal parser families, including WinMerge's whole-comment-line, UTF-16 tokenization, embedded-NUL, quote, column, continuation, language-mode, and long-delimiter quirks; C/C++ digit-separator/raw-string and C# verbatim-string corners, HTML embedded languages, Tree-sitter-backed TypeScript/TSX, and remaining ABAP/ASP/AutoIt/D/F#/Go/PHP/Rust/Smarty parser families are pending.
